...
namespace Sysne.Core.ApiClient
{
    public class WebApiClient : HttpClient
    {
        ...
        public WebApiClient(string urlBase = null, string urlController = null) : base(CertValidator.CertHandler)
        {
            ...
            var isUrlControllerNull = string.IsNullOrEmpty(urlController);
        ...
        private async Task<(HttpStatusCode StatusCode, IEnumerable<string> Content)> ProcessResponse<TResponse>(HttpRequestMessage requestMessage)
        {
            try
            {
                ...
                {
                    var response = res.Headers.GetValues("JSESSIONID");
        ...
        public async Task<(HttpStatusCode StatusCode, TResponse Content)> CallAsync<TResponse>(HttpMethod method, string url, HttpContent content = null)
        {
            ...
            return ((HttpStatusCode StatusCode, TResponse Content))await ProcessResponse<TResponse>(requestMessage);
        }
